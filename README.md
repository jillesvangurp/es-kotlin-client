...
**As of now, es-kotlin-client is deprecated and no longer maintained.** However, it lives on as the `legacy-client` in `kt-search`. When we release kt-search, using that will be your upgrade path.
